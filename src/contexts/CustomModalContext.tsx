...
export const CustomModalProvider: any = ({ children }:any) => {
  const [modalData, setModalData] = useState<ModalDataProps>({ open: false, componenet: null });
  ...
  const closeModal = () => {
    setModalData({ ...modalData, open: false, componenet: null,headerTitle:"",action:undefined,formData:undefined})
  };

  return (
    <CustomModalContext.Provider
      value={{ modalData, closeModal, openModal }}
    >
      {children}
    </CustomModalContext.Provider>
  );
